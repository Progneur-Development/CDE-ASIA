...
public class CDEFabricationCADHandler extends AbstractHandler {
	/**
	 * The constructor.
	 */
	Text itemIDText;
	...
	private TCComponentItemRevision itemRev;
		...
		void UI()
		{
			...
			btnOk.addSelectionListener(new SelectionListener() {
				...
				private TCComponent createObjResponse;
				...
				public void widgetSelected(SelectionEvent arg0) {
					...
					dmService = DataManagementService.getService(session);
							...
							//	TCComponentFolder folder= session.getUser().getHomeFolder();
								 ...
								 itemDef.data.boName = "CD5CDEFabCAD"; 
								 ...
								 itemRevisionDef.boName = "CD5CDEFabCADRevision"; 
								 itemRevisionDef.stringProps.put("object_desc","asd"); 
